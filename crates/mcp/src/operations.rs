...
use docracy_core::errors::CoreError;
...
pub async fn init_bundle(runtime: &mut McpRuntime) -> Result<InitBundleResult, CoreError> {
...
pub async fn create_document(
    ...
    docracy_core::create_document(&mut runtime.repo, &runtime.clock, &runtime.ids, input).await
}
...
pub async fn read_documents(
    ...
    docracy_core::read_documents(&runtime.repo, ids).await
}
...
pub async fn query_documents(
    ...
    docracy_core::query_documents(&runtime.repo, input).await
}
...
pub async fn update_document(
    ...
    docracy_core::update_document(&mut runtime.repo, &runtime.clock, &runtime.ids, input).await
}
